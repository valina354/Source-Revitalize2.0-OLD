...
//ConVar	sk_max_slam("sk_max_slam", "0", FCVAR_REPLICATED); no point
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	CHalfLife2::CHalfLife2()
	{
		...
		// Map Labs - Stunstick behavior should be set to 1 by default
		// to reflect existing Map Labs behavior (Blixibon)
		m_StunstickPickupBehavior = 1;
#endif
	}
